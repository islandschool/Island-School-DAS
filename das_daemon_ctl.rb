...
SERVICE_NAME = "DasPollingDaemon"
SERVICE_DISP = "DAS Polling Daemon"
SERVICE_DESC = "Polling service that communicates with modbus networked devices."
